...
use tei187\ColorTools\Math\DeltaE\CIE94;
use tei187\ColorTools\Math\DeltaE\CIEDE2000;
use tei187\ColorTools\Math\DeltaE\CMC_lc;
use tei187\ColorTools\Dictionaries\DeltaE\Dictionary;
use tei187\ColorTools\Helpers\ArrayMethods;
use tei187\ColorTools\Helpers\ClassMethods;

trait CalculatesDeltaE {
    /**
     * Checks if passed argument is proper to do deltaE calculations.
     *
     * @param mixed $data The input data to be validated.
     * @return array|false The validated data array, or false if the input is not valid.
     */
        ...
        switch(gettype($data)) {
            ...
            case 'object':
                if( ClassMethods::checkForInterface($data, 'tei187\\ColorTools\\Interfaces\\Measure') &&
                    ClassMethods::checkForTrait($data, 'tei187\\ColorTools\\Traits\\UsesIlluminant') && 
